...
drush dl -y drupal-9.2.x --dev --destination=/tmp --default-major=9 --drupal-project-rename=drupal
...
sudo rm -rf /var/www/html.bak/html || true
sudo mv /var/www/html /var/www/html.bak || true
COMPOSER_MEMORY_LIMIT=-1 composer create-project ymcatwincities/openy-project:9.2.x-dev /var/www/html --no-interaction
cd /var/www/html/
